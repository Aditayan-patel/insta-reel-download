        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <div className="relative mx-auto mt-12 hidden w-full max-w-5xl md:block">
            ...
            <div className="absolute left-0 right-0 top-24 h-0.5">
              ...
              {/* Animated Dot */}
              <div className="absolute top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-teal-500 animate-[moveDot_3s_ease-in-out_infinite]" />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 mb-6">
                      <div className={`absolute inset-0 rounded-full bg-gradient-to-br ${step.color} opacity-0 blur-xl transition-all duration-300 group-hover:opacity-30`} />
                      <div className={`relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br ${step.color} text-xl font-bold text-white shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl`}>
                        {index + 1}
                      </div>
                    </div>
                    ...
                    <div className="relative w-full overflow-hidden rounded-2xl border border-slate-200/80 bg-white/80 p-6 backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:border-slate-300 hover:shadow-xl hover:shadow-slate-200/50 dark:border-slate-800/80 dark:bg-slate-900/80 dark:hover:border-slate-700 dark:hover:shadow-slate-900/50">
                      {/* Card Hover Gradient */}
                      <div className={`absolute inset-0 bg-gradient-to-br ${step.bgLight} opacity-0 transition-opacity duration-300 group-hover:opacity-100 dark:opacity-0`} />
                      
                      <div className="relative">
                        {/* Icon */}
                        <div className={`mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl ${step.iconBg} ring-1 ring-slate-200/60 transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg dark:ring-slate-700/60 ${step.darkIconBg}`}>
                          <Icon className={`h-7 w-7 ${step.iconColor} ${step.darkIconColor}`} />
                        </div>
                      ...
                      {/* Bottom Accent Line */}
                      <div className={`absolute bottom-0 left-1/2 h-1 w-0 -translate-x-1/2 rounded-full bg-gradient-to-r ${step.color} transition-all duration-300 group-hover:w-3/4`} />
                    </div>
                  </div>
                );
              })}
          ...
          <div className="relative mx-auto w-full max-w-md space-y-6 md:hidden">
            ...
            <div className="absolute left-[22px] top-4 bottom-4 w-0.5">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex-shrink-0">
                    <div className={`flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br ${step.color} text-base font-bold text-white shadow-md transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg`}>
                      {index + 1}
                    </div>
                  </div>
                  ...
                  <div className="relative flex-1 overflow-hidden rounded-xl border border-slate-200/80 bg-white/80 p-4 backdrop-blur-sm transition-all duration-300 hover:border-slate-300 hover:shadow-lg dark:border-slate-800/80 dark:bg-slate-900/80 dark:hover:border-slate-700">
                    <div className="mb-2 flex items-center gap-2">
                      <div className={`rounded-lg ${step.iconBg} p-1.5 ${step.darkIconBg}`}>
                        <Icon className={`h-4 w-4 ${step.iconColor} ${step.darkIconColor}`} />
                      </div>
